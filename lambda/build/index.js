...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var bucket, key, params, ContentType, err_1, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                bucket = event.queryStringParameters.bucket;
                key = decodeURIComponent(event.queryStringParameters.objectKey.replace(/\+/g, ' '));
                params = {
                    Bucket: bucket,
                    Key: key,
                };
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, s3.getObject(params)];
            case 2:
                ContentType = (_a.sent()).ContentType;
